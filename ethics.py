...
class ĐukaBio:
    ...
    BASE_RULES = [
        ...
        EthicalRule(
            ...
            condition=lambda ctx: ctx.get('data_type') in ['face', 'voice', 'location'] 
    ...
    def __init__(self, node_id: str, custom_rules: Optional[List[EthicalRule]] = None):
        ...
        self.rules = self.BASE_RULES + (custom_rules or [])
    ...
    def validate_action(self, action_context: dict) -> tuple[bool, Optional[str]]:
